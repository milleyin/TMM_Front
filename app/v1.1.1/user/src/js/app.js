...
tmmApp.config(['$routeProvider','$httpProvider',function ($routeProvider, $httpProvider) {
    ...
    $routeProvider
        ...
        .when('/jbydetail_2/:id',{
          templateUrl : 'tpls/jbydetail_2.html',
         	controller : 'jiebanyou2Ctrl'
        })
        .when('/jbydetail_3/:id',{
          templateUrl : 'tpls/jbydetail_3.html',
          controller : 'jiebanyou3Ctrl'
        })
        .when('/jbydetail_4/:id',{
          templateUrl : 'tpls/jbydetail_4.html',
         	controller : 'jiebanyou4Ctrl'
        })
        .when('/jbydetail_5/:id',{
          templateUrl : 'tpls/jbydetail_5.html',
          controller : 'jiebanyou5Ctrl'
        })
        .when('/jbydetail_6/:id',{
          templateUrl : 'tpls/jbydetail_6.html',
          controller : 'jiebanyou6Ctrl'
        })
        .when("/quxiaodetail",{
