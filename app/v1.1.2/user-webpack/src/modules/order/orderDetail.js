  ...
  showQrCode: function(){
    ...
    if ($$(this).attr('data-sq') == 1) {
      ...
      httpService.getQrCode(link,function(dataRes){
        ...
        var html = '<div class="popup" id="popupQRcode"><div style="top: 75%;position: absolute;width: 100%;"><p><a href="#" class="close-popup button color-red active" style="margin: 30px 16px;">关闭</a></p></div><div style="margin:20%;"></div></div>'
        tmmApp.popup(html);
  ...
  setTime: function() {
    ...
    timer = setInterval(function(){
      ...
      orderDetail.getOrderInfo(function(){
       log.info(orderInfo);
        // 订单状态变为待支付状态才能提交订单
        if (orderInfo.status.order_status.value == 1) {
