tmmApp.controller('myCtrl', ['$scope', '$http', '$location', 'bottomBarService','$rootScope',function($scope, $http, $location, bottomBarService, $rootScope) {
    // $scope.isLogin = false;
    ...
    $http.get(API + '/index.php?r=store/store_home/index').success(function(data) {
        ...
        $rootScope.loginPhone = data.data.phone;
