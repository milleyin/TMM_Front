/* 修改手机号 */
tmmApp.controller('SetPhoneCtrl',['$scope','$rootScope','$http','$interval','$location',function($scope,$rootScope, $http, $interval,$location) {
    $scope.oldInfo = {
        phoneInfo : '请输入旧手机号',
        submit : '下一步'
    }
    ...
    /* 获取csrf码 */
    $http.get(API + '/index.php?r=api/user/phone_old'+'&csrf=csrf').success(function(data) {
    ...
    $scope.getCode = function() {
        ...
        $http.post(
            API + '/index.php?r=api/user/captcha_old_sms',
            getCodeInfo,
            {
    ...
    $scope.submit = function() {
        ...
        $http.post(
            API + '/index.php?r=api/user/phone_old',
            postInfo,
            {
                headers:{'Content-Type': 'application/x-www-form-urlencoded'}
            }
