...
var shop = {
  ...
  initDetail: function() {
    ...
    if (type == 'dot') {
      ...
      var actType = $$(_this).attr('data-acttype');
      // 0为活动（旅游）1 为活动（农产品）
      if (actType == 0) {
        shop.getActDetail(link);
      }
    } else {
  ...
  /**
   * 提取线与活动的项目
   * @param  {[type]} data 线与活动的list
   * @return {[type]} arr 线与活动的项目集合
   */
