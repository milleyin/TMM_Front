...
//我参加的活动列表页
.controller('MyJoinActCtrl', function($scope, $ionicScrollDelegate, $ionicPopover, $filter, $ionicLoading, orderType, data, Resource, autoRefresh, appFunc, modify, payFunc, uiCalendar, device, ENV) {
