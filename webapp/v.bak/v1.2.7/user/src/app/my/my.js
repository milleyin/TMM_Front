...
.config(['$stateProvider', function($stateProvider) {
  $stateProvider
    .state('tab.my', {
      ...
      controller: 'MyCtrl',
      resolve: {
        data: function($ionicViewSwitcher, $ionicHistory, device, ENV) {
          if (ENV.device === 'app') {
...
.controller('MyCtrl', function($scope, $ionicHistory, security, Resource, ENV) {
  ...
  $scope.isWeixin = (ENV.device === 'weixin');
