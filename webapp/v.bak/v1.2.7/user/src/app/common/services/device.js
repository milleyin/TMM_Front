...
.factory('device', function($ionicHistory, $ionicPopup, $rootScope, $filter, modify, appFunc, ENV, Resource) {
  ...
  var device = {
    ...
    goSeekFreshDetail2: function(title, description, thumb_url, webpageUrl) {
      try {
        title = $filter('html2Txt')(title);
        description = $filter('html2Txt')(description);
