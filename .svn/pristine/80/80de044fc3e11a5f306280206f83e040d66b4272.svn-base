...
.config(function($httpProvider, $stateProvider, $urlRouterProvider, $ionicConfigProvider, $logProvider) {
  ...
  .state('tab.launch-act', {
    ...
    views: {
      'tab-my': {
        ...
        controller: 'MylaunchCtrl'
      }
    }
  })

  .state('tab.launch-act-selline', {
    url: '/launch-act-selline',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-selline.html',
      }
    }
  })

  .state('tab.launch-act-sellinedeta', {
    url: '/launch-act-sellinedeta',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-selline-details.html',
      }
    }
  })

  .state('tab.launch-act-seldotdeta', {
    url: '/launch-act-seldotdeta',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-seldot-details.html',
      }
    }
  })

  .state('tab.launch-act-seldot-schedule', {
    url: '/launch-act-seldot-schedule',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-seldot-schedule.html',
      }
    }
  })
  
  .state('tab.launch-act-seldot-addact-schedule', {
    url: '/launch-act-seldot-addact-schedule',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-seldot-addact-schedule.html',
      }
    }
  })

  .state('tab.launch-act-seldot-addact-info', {
    url: '/launch-act-seldot-addact-info',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-seldot-addact-info.html',
      }
    }
  })
  ...
  .state('tab.launch-end-actdeta', {
    url: '/launch-end-actdeta',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-end-details.html'
      }
    }
  })

  .state('tab.launch-end-more-actdeta', {
    url: '/launch-end-more-actdeta',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-end-more-details.html'
      }
    }
  })

  .state('tab.launch-end-enrollinfo-actdeta', {
    url: '/launch-end-enrollinfo-actdeta',
    views: {
      'tab-my': {
        templateUrl: 'tpls/launch-act-end-enrollinfo-details.html'
      }
    }
  })
