...
.controller('SilderController', ['$scope', '$element', function($scope, $element) {
  ...
  function render() {
    ...
    oUl.style.cssText = "width:100%; line-height: 0; position:absolute; bottom: 8px; text-align:center;"
...
.directive('slider', function() {
  ...
  return {
    ...
    template: '<div ratio class="wrap"><div class="img-wrap" ng-transclude>12</div></div>'
  }
})
