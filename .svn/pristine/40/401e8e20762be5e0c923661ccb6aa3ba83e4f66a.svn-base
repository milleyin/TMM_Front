var list = [{
	height: 480,
	width: 750,
	img: "../data/img/banner02.png"
},
{
	height: 480,
	width: 750,
	img: "../data/img/banner03.png"
},
{
	height: 480,
	width: 750,
	img: "../data/img/banner04.png"
},
{
	height: 480,
	width: 750,
	img: "../data/img/banner05.png"
},
{
	height: 480,
	img: "../data/img/banner06.png",
	width: 750
},
{	
	height: 480,
	img: "../data/img/banner07.png",
	width: 750
}];
...
Slider.prototype.renderDOM = function(){
	...
	for(var i = 0; i < len; i++){
		...
		var item = data[i];
		var height = item['height']/item['width'] * window.innerWidth;
		...
		if(item){
			...
			li.innerHTML = '<img height="'+ height +'" src="'+ item['img'] +'">';
		}
