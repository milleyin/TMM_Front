        ...
        if (data.status == 0) {
          if (data.form) {
            if (data.form.Retinue_identity) {
              msg = data.form.Retinue_identity[0];
            } else if (data.form.Retinue_name) {
              msg = data.form.Retinue_name[0];
            } else if (data.form.Retinue_phone) {
              msg = data.form.Retinue_phone[0];
            } else if (data.form.Retinue_is_main) {
              msg = data.form.Retinue_is_main[0];
            } else if (data.form.Retinue_email){
              msg = data.form.Retinue_email[0];
            } else {
          ...
          if (retinueInfo.type == 2 || retinueInfo.type == 2) {
            msg = '添加成功';
          } else {
            msg = '修改成功';
          }
