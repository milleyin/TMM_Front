...
tmmApp.controller('MobLoginCtrl',['$scope','$rootScope','$http','$interval','$location',function($scope,$rootScope, $http, $interval,$location) {
    ...
    $scope.showCode = function() {
        ...
        $http.get(API + '/index.php?r=api/login/captcha_sms'+'&csrf=csrf').success(function(data) {
    ...
    $scope.submit = function() {     
        $http.get(API + '/index.php?r=api/login/captcha_sms'+'&csrf=csrf').success(function(dataRes) {
            var postInfo = {
                "UserSmsLoginForm" : { 
                    "phone" : $scope.regText.name,
                ...
                "TMM_CSRF" : dataRes.data.csrf.TMM_CSRF
            }
