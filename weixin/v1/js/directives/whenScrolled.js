tmmApp.directive('whenScrolled', function() {
...
tmmApp.controller('SilderController', ['$scope', '$element', function($scope, $element) {
  var self = this,
...
tmmApp.directive('slider', function() {
...
tmmApp.directive('sliderItem', function() {
